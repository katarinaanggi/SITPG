...
<body>
    ...
    <a href="<?php echo e(URL::previous()); ?>"><i class="bi bi-x-lg"></i></a>
    <div class="main-container">
        ...
        <div class="article-meta">
            <div class="author">
                ...
                <p class="dateline"><?php echo e($berita->created_at->format('M d, Y')); ?></p>
            </div>
            ...
            <aside>
                <blockquote class="bq-short">
                    <?php if($berita->nama_file): ?>
                        <a href="<?php echo e(route('downloadFile', $berita->nama_file)); ?>" class="mr-auto">Download file</a>
                    <?php endif; ?>
                </blockquote>
            </aside>
        </div>
...
</html><?php /**PATH E:\IF\Semester 5\Pengembangan Berbasis Platform\Laravel\SITPG\resources\views/dashboard/berita/detail.blade.php ENDPATH**/ ?>