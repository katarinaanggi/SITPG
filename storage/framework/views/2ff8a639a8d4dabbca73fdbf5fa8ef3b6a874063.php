...
<body>
    <div class="wrapper fadeInDown">
        <div id="formContent" >
            ...
            <form method="POST" action="<?php echo e(route('user.check')); ?>" autocomplete="off">
...
</html><?php /**PATH E:\IF\Semester 5\Pengembangan Berbasis Platform\Laravel\SITPG\resources\views/dashboard/user/login.blade.php ENDPATH**/ ?>