  ...
  <section class="error">
    ...
    <div class="error__content">
      ...
      <div class="error__nav e-nav">
        <a href="<?php echo e(route('admin.home')); ?>" target="_blanck" class="e-nav__link"></a>
      </div>
    </div>
    <!-- END Content -->
...
<?php /**PATH E:\IF\Semester 5\Pengembangan Berbasis Platform\Laravel\SITPG\resources\views/errors/404.blade.php ENDPATH**/ ?>