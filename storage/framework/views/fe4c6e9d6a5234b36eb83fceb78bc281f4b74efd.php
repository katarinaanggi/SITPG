        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-pills" id="pills-import" role="tablist">
                    <?php if($key = Session::get('pill')): ?>  
                        <li class="nav-item" role="presentation">
                            <button class="nav-link card-title <?php echo e(($key == 'dataguru') ? 'active' : ''); ?>" id="pills-dg-tab" data-bs-toggle="pill" data-bs-target="#pills-dg" role="tab" aria-controls="pills-dg" aria-selected="true">Data Guru</button>
                        </li>
                        <?php if(auth()->guard('admin')->check()): ?>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link card-title <?php echo e(($key == 'import') ? 'active' : ''); ?>" id="pills-imp-tab" data-bs-toggle="pill" data-bs-target="#pills-imp" role="tab" aria-controls="pills-imp" aria-selected="false">Import Excel</button>
                        </li>
                        <?php endif; ?>
                    <?php else: ?>
                        <li class="nav-item" role="presentation">
            ...
            <div class="card-body" >
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <a class="btn btn-save" href="<?php echo e(route('operator.deleteAll_guru')); ?>" id="delall">Delete All Data</a><br /><br />
                        <div class="tab-pane fade <?php echo e(($key == 'dataguru') ? 'show active' : ''); ?>" id="pills-dg" role="tabpanel" aria-labelledby="pills-dg-tab">
                        ...
                        <?php if(auth()->guard('admin')->check()): ?>
                            <div class="tab-pane fade <?php echo e(($key == 'import') ? 'show active' : ''); ?>" id="pills-imp" role="tabpanel" aria-labelledby="pills-imp-tab">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\IF\Semester 5\PBP\Laravel\SITPG\resources\views/dashboard/guru/guru.blade.php ENDPATH**/ ?>