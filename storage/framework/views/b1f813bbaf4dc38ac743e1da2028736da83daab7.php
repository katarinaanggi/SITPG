...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control itungan" id="gaji_pokok" name="gaji_pokok" value="<?php echo e($guru->gaji_pokok); ?>">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="tw1" role="tabpanel" aria-labelledby="tw1-tab"><br>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan " id="jan" name="jan" value="<?php echo e($guru->jan); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="feb" name="feb" value="<?php echo e($guru->feb); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="mar" name="mar" value="<?php echo e($guru->mar); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="tw2" role="tabpanel" aria-labelledby="tw2-tab"><br>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="apr" name="apr" value="<?php echo e($guru->apr); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="mei" name="mei" value="<?php echo e($guru->mei); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="jun" name="jun" value="<?php echo e($guru->jun); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="tw3" role="tabpanel" aria-labelledby="tw3-tab"><br>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="jul" name="jul" value="<?php echo e($guru->jul); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="agu" name="agu" value="<?php echo e($guru->agu); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="sep" name="sep" value="<?php echo e($guru->sep); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="tw4" role="tabpanel" aria-labelledby="tw4-tab"><br>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="okt" name="okt" value="<?php echo e($guru->okt); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="nov" name="nov" value="<?php echo e($guru->nov); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control itungan" id="des" name="des" value="<?php echo e($guru->des); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
