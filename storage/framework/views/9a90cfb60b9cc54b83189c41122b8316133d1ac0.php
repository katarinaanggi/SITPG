...
<form action="<?php echo e(route('operator.store_guru')); ?>" method="post" class="needs-validation" novalidate id="formvalid">
    <?php echo csrf_field(); ?>
            ...
            <div class="card-content">
                ...
                <div class="card-body">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="no_peserta" name="no_peserta" value="<?php echo e(old('no_peserta')); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="nip" name="nip" value="<?php echo e(old('nip')); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                            <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="nrg" name="nrg" value="<?php echo e(old('nrg')); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                                    <?php $__errorArgs = ['nrg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="nuptk" name="nuptk" value="<?php echo e(old('nuptk')); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="no_sk" name="no_sk" value="<?php echo e(old('no_sk')); ?>" required>
                                ...
                                <div class="col-sm-9">
                                    <label class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" id="pengawas" name="jenjang" value="PENGAWAS" <?php echo e((old('jenjang') == 'PENGAWAS') ? 'checked' : ''); ?> required> Pengawas <br/>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="tempat_tugas" name="tempat_tugas" value="<?php echo e(old('tempat_tugas')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama_bank" name="nama_bank" value="<?php echo e(old('nama_bank')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kantor_cabang" name="kantor_cabang" value="<?php echo e(old('kantor_cabang')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="no_rek" name="no_rek" value="<?php echo e(old('no_rek')); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama_rek" name="nama_rek" value="<?php echo e(old('nama_rek')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="masa_kerja" name="masa_kerja" value="<?php echo e(old('masa_kerja')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="gaji_pokok" name="gaji_pokok" value="<?php echo e(old('gaji_pokok')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="jumlah" name="jumlah" value="<?php echo e(old('jumlah')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="pajak" name="pajak" value="<?php echo e(old('pajak')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="bpjs" name="bpjs" value="<?php echo e(old('bpjs')); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\IF\Semester 5\PBP\Laravel\SITPG\resources\views/dashboard/guru/add_guru.blade.php ENDPATH**/ ?>