        ...
        <div class="col-12 col-md-12">
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-header"><h3 class="text-center">User Detail for <?php echo e($user->name); ?></h3></div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kota" name="kota" value="<?php echo e($user->kotaid->nama_kota); ?>" readonly>
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col">
                                    <a href="<?php echo e(route('admin.userManagement')); ?>" class="btn" style="width: 100%">Kembali</a>
                                </div>
                                <div class="col">
                                    <a href="<?php echo e(route('admin.edit_user', $user->id)); ?>" class="btn btn-save" style="width: 100%">Edit</a>
                                </div>
                            </div>
                    </div>
                </div>
...
</html><?php /**PATH E:\IF\Semester 5\PBP\Laravel\SITPG\resources\views/dashboard/usermanagement/detail.blade.php ENDPATH**/ ?>